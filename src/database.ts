...
const MongoMatch =
  (mongoose.models.Match as mongoose.Model<Match>) ||
  mongoose.model<Match>("Match", MatchSchema);

const MongoPrediction =
  (mongoose.models.Prediction as mongoose.Model<Prediction>) ||
  mongoose.model<Prediction>("Prediction", PredictionSchema);

const MongoUserStats =
  (mongoose.models.UserStats as mongoose.Model<UserStats>) ||
  mongoose.model<UserStats>("UserStats", UserStatsSchema);
